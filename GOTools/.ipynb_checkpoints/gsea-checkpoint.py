...
def mk_gset(idata, orgdb, genelist_sep=';'):
    """
...
def run_gsea(ifile, odir, TERM2GENE, TERM2NAME, has_header=False, idx_trt=None, idx_con=None, rnk_score_method='Signal2Noise', orgdb='org.Hs.eg.db', nPerm=1000, minGSSize=10, maxGSSize=500, pvalueCutoff=0.05, is_convert_symbol_back=True):
    """
    Required:
