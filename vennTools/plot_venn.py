...
def plot_venn2(isets, labels=('grpA', 'grpB'), colors=('#e74c3c', '#00755E'), linestyle='-', linewidth=1, linecolor="grey", ofile=None, figsize=(6, 6), fontsize=14, dpi=300):
    """
    Plot 2 venn
...
def plot_venn2_num(subsets, labels=('grpA', 'grpB'), colors=('#e74c3c', '#00755E'), linestyle='-', linewidth=1, linecolor="grey", ofile=None, figsize=(6, 6), fontsize=14, dpi=300):
    """
    Plot 2 venn

    Required:
    subsets:<tuple> a tuple contains numbers of 'v10, v01, v11'
...
def plot_venn3(isets, labels=('grpA', 'grpB', 'grpC'), colors=('#e74c3c', '#3498db', '#00755E'), linestyle='-', linewidth=1, linecolor="grey", fontsize=14, ofile=None, figsize=(6, 6), dpi=300):
    """
    Plot 3 venn
