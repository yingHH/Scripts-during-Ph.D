# -*- coding: utf-8 -*-
"""
Created on 2018-11-18 21:23:14
Last Modified on 2018-11-18 21:23:14
...
def separate_chrom(chr_size, bin_size):
    """chr_size: <int> chromsome szie"""
...
def count_reads_in_each_bin(ibed, ibams, ofile):
    """Count reads in each genome bin.
